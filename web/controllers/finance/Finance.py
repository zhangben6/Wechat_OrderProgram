...
from common.libs.Helper import iPagination,selectFilterObj,getDictFilterField,getCurrentDate
...
def set():
    ...
    # 计算总价钱
    pay_info_list = PayOrder.query.filter_by(status=1).all()
    total_money = 0
    for item in pay_info_list:
    ...
    resp_data['list'] = list
    resp_data['pages'] = pages
    resp_data['total_money'] = int(total_money)
